...
def enumerate_fp6_values():
    """
    Enumerates all possible values for a simplified 6-bit floating-point format.
    ...
    For this 3-bit exponent, the bias is 2^(3-1) - 1 = 3.
    The mantissa has an implicit leading '1'.
    """
    values = []
    
    # Iterate through all 64 possible 6-bit combinations
    for i in range(64):
        ...
        # Calculate the exponent value, with a bias of 3
        exponent = exponent_bits - 3
        
        # Calculate the mantissa value from the 2 mantissa bits.
        # The bits correspond to fractional values of 0.5 and 0.25.
        m1 = (mantissa_bits >> 1) & 1
        m2 = mantissa_bits & 1
        mantissa_fraction = m1 * 0.5 + m2 * 0.25
...
def main():
    ...
    """
    # Get all 64 FP6 values
    all_values = enumerate_fp6_values()
    ...
    print("Enumerated and sorted positive FP6 values:")
    print("-" * 50)
