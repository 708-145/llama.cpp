...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_GRANITE_MOE_HYBRID, "granite_moe_hybrid" },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    {
        LLM_ARCH_LLAMA,
        {
            ...
            { LLM_TENSOR_FFN_EXPERT_GATE_INP, "blk.%d.ffn_expert.%d.gate_inp" },
            { LLM_TENSOR_FFN_EXPERT_DOWN,     "blk.%d.ffn_expert.%d.down"     },
            { LLM_TENSOR_FFN_EXPERT_UP,       "blk.%d.ffn_expert.%d.up"       },
        },
    },
    {
        LLM_ARCH_DECI,
        {
            ...
            { LLM_TENSOR_FFN_DOWN_EXPS,   "blk.%d.ffn_down_exps" },
            { LLM_TENSOR_FFN_UP_EXPS,     "blk.%d.ffn_up_exps" },
            // SSM tensors for GRANITE_MOE_HYBRID
            { LLM_TENSOR_SSM_IN_W,        "blk.%d.ssm_in.weight" },
            { LLM_TENSOR_SSM_CONV1D_W,    "blk.%d.ssm_conv1d.weight" },
            { LLM_TENSOR_SSM_CONV1D_B,    "blk.%d.ssm_conv1d.bias" },
            { LLM_TENSOR_SSM_X_W,         "blk.%d.ssm_x.weight" },
            { LLM_TENSOR_SSM_DT_W,        "blk.%d.ssm_dt.weight" },
            { LLM_TENSOR_SSM_DT_B,        "blk.%d.ssm_dt.bias" },
            { LLM_TENSOR_SSM_A_W,         "blk.%d.ssm_a.weight" },
            { LLM_TENSOR_SSM_D_W,         "blk.%d.ssm_d.weight" },
            { LLM_TENSOR_SSM_OUT_W,       "blk.%d.ssm_out.weight" },
        },
    },
    {
        LLM_ARCH_BAICHUAN,
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_FFN_EXPERT_GATE_INP,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_EXPERT_DOWN,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_EXPERT_UP,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
