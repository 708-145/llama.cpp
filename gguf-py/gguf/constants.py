...
class MODEL_ARCH(IntEnum):
    ...
    PLM              = auto()
    MMPROJ           = auto()
    LLAMA4           = auto() # For Llama-4 / SmolVLM
    QWEN3            = auto()
    QWEN3MOE         = auto()
    DOTS1            = auto()
    GLM4             = auto()
...
class MODEL_TENSOR(IntEnum):
    ...
    # Vision model related tensors for MMPROJ
    V_ENC_EMBD_PATCH     = auto()
    V_ENC_EMBD_POS       = auto()
    V_ENC_BLOCK_ATTN_NORM = auto()
    V_ENC_BLOCK_ATTN_QKV = auto() # Combined QKV for vision encoder
    V_ENC_BLOCK_ATTN_OUT = auto()
    V_ENC_BLOCK_FFN_NORM = auto()
    V_ENC_BLOCK_FFN_UP   = auto()
    V_ENC_BLOCK_FFN_DOWN = auto()
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    # Vision model tensor names
    MODEL_TENSOR.V_ENC_EMBD_PATCH:          "vision_encoder.patch_embedding",
    MODEL_TENSOR.V_ENC_EMBD_POS:            "vision_encoder.position_embedding",
    MODEL_TENSOR.V_ENC_BLOCK_ATTN_NORM:     "vision_encoder.block.{bid}.attn_norm",
    MODEL_TENSOR.V_ENC_BLOCK_ATTN_QKV:      "vision_encoder.block.{bid}.attn_qkv",
    MODEL_TENSOR.V_ENC_BLOCK_ATTN_OUT:      "vision_encoder.block.{bid}.attn_output",
    MODEL_TENSOR.V_ENC_BLOCK_FFN_NORM:      "vision_encoder.block.{bid}.ffn_norm",
    MODEL_TENSOR.V_ENC_BLOCK_FFN_UP:        "vision_encoder.block.{bid}.ffn_up",
    MODEL_TENSOR.V_ENC_BLOCK_FFN_DOWN:      "vision_encoder.block.{bid}.ffn_down",
...
MODEL_TENSORS[MODEL_ARCH.LLAMA] = [
...
MODEL_TENSORS[MODEL_ARCH.GPTNEOX] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.FALCON] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.BAICHUAN] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.STARCODER] = [
        MODEL_TENSOR.TOKEN_EMBD,
...
MODEL_TENSORS[MODEL_ARCH.NOMIC_BERT] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.TOKEN_TYPES,
        MODEL_TENSOR.POS_EMBD,
...
MODEL_TENSORS[MODEL_ARCH.JINA_BERT_V2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.TOKEN_TYPES,
        MODEL_TENSOR.ATTN_NORM_2,
...
MODEL_TENSORS[MODEL_ARCH.REFACT] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.BLOOM] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.STABLELM] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.QWEN2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.QWEN2VL] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.QWEN2MOE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.PLAMO] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.PHIMOE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FACTORS_LONG,
...
MODEL_TENSORS[MODEL_ARCH.CODESHELL] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.POS_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.ORION] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.INTERNLM2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.MINICPM] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.MINICPM3] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FACTORS_LONG,
...
MODEL_TENSORS[MODEL_ARCH.GEMMA] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_NORM,
        MODEL_TENSOR.ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.GEMMA2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_Q,
        MODEL_TENSOR.ATTN_K,
...
MODEL_TENSORS[MODEL_ARCH.GEMMA3] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.STARCODER2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.RWKV6] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.RWKV6QWEN2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.RWKV7] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.ARWKV7] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.MAMBA] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.XVERSE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.COMMAND_R] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_NORM,
        MODEL_TENSOR.ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.COHERE2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_NORM,
        MODEL_TENSOR.ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.OLMO2] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.OLMOE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_OUT,
...
MODEL_TENSORS[MODEL_ARCH.OPENELM] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.ATTN_NORM,
        MODEL_TENSOR.ATTN_QKV,
...
MODEL_TENSORS[MODEL_ARCH.ARCTIC] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.DEEPSEEK] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.CHATGLM] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.ROPE_FREQS,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
...
MODEL_TENSORS[MODEL_ARCH.BITNET] = [
        MODEL_TENSOR.ATTN_Q,
        MODEL_TENSOR.ATTN_K,
        MODEL_TENSOR.ATTN_V,
        MODEL_TENSOR.TOKEN_EMBD,
...
MODEL_TENSORS[MODEL_ARCH.T5ENCODER] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ENC_ATTN_NORM,
        MODEL_TENSOR.ENC_ATTN_Q,
...
MODEL_TENSORS[MODEL_ARCH.NEMOTRON] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.EXAONE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ROPE_FREQS,
...
MODEL_TENSORS[MODEL_ARCH.GRANITE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.GRANITE_MOE] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
...
MODEL_TENSORS[MODEL_ARCH.WAVTOKENIZER_DEC] = [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.TOKEN_EMBD_NORM,
        MODEL_TENSOR.CONV1D,
...
# TODO
MODEL_TENSORS[MODEL_ARCH.MMPROJ] = [
        MODEL_TENSOR.V_ENC_EMBD_PATCH,
        MODEL_TENSOR.V_ENC_EMBD_POS,
        MODEL_TENSOR.V_ENC_BLOCK_ATTN_NORM,
        MODEL_TENSOR.V_ENC_BLOCK_ATTN_QKV,
        MODEL_TENSOR.V_ENC_BLOCK_ATTN_OUT,
        MODEL_TENSOR.V_ENC_BLOCK_FFN_NORM,
        MODEL_TENSOR.V_ENC_BLOCK_FFN_UP,
        MODEL_TENSOR.V_ENC_BLOCK_FFN_DOWN,
        MODEL_TENSOR.V_MMPROJ_FC,
        MODEL_TENSOR.V_IMG_EMBD,
        MODEL_TENSOR.V_TOK_EMBD_IMG_BREAK,
]
# Ensure LLAMA4 is defined after LLAMA
MODEL_TENSORS[MODEL_ARCH.LLAMA4] = MODEL_TENSORS[MODEL_ARCH.LLAMA].copy() # Llama4 is similar to Llama but may have variations
MODEL_TENSORS[MODEL_ARCH.QWEN3] = MODEL_TENSORS[MODEL_ARCH.QWEN2].copy()
MODEL_TENSORS[MODEL_ARCH.QWEN3MOE] = MODEL_TENSORS[MODEL_ARCH.QWEN2MOE].copy()
