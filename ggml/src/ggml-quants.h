...
GGML_API void quantize_row_fp8_ref(const float * GGML_RESTRICT x, block_fp8 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_fp8(const block_fp8 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
